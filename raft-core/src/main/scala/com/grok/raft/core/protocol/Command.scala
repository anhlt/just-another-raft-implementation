...
case class Scan(prefix: Array[Byte], limit: Option[Int] = None) extends ReadCommand[List[(Array[Byte], Array[Byte])]]

case class Keys(prefix: Option[Array[Byte]] = None, limit: Option[Int] = None) extends ReadCommand[List[Array[Byte]]]
