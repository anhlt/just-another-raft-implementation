...
object Dependencies {
  ...
  val catsMtl          = Def.setting("org.typelevel" %% "cats-mtl" % "1.7.0")
  ...
  val logback          = Def.setting("ch.qos.logback" % "logback-classic" % "1.5.38" % Test)
  val catsEffect       = Def.setting("org.typelevel" %% "cats-effect" % "3.7.0")
  val catsEffectKernel = Def.setting("org.typelevel" %% "cats-effect-kernel" % "3.7.0")
  val catsEffectStd    = Def.setting("org.typelevel" %% "cats-effect-std" % "3.7.0")
  ...
  val rocksDB              = Def.setting("org.rocksdb" % "rocksdbjni" % "8.11.4")
  val scodecCore           = Def.setting("org.scodec" %% "scodec-core" % "2.2.2")
  val scodecCats           = Def.setting("org.scodec" %% "scodec-cats" % "1.2.0")
}
